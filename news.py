...
# 네이버 뉴스 >>  검색 '푸바오'
# https://search.naver.com/search.naver?ssc=tab.news.all&where=news&sm=tab_jum&query=%ED%91%B8%EB%B0%94%EC%98%A4
...
# driver.get('https://search.naver.com/search.naver?ssc=tab.news.all&where=news&sm=tab_jum&query=푸바오')
